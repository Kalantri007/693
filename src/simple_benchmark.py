...
class SimpleRecommendationBenchmark:
    """Simplified benchmark class for comparing friend recommendation algorithms"""
...
if __name__ == "__main__":
    ...
    benchmark = SimpleRecommendationBenchmark()
    benchmark.run_benchmark(num_users=5)  # Use 5 random users for testing
